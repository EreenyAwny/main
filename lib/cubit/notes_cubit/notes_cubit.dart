...
class NotesCubit extends Cubit<NotesStates>{
 ...
 Future<void>getnotes()async{
  ...
  emit(loadingstate());
  try{
QuerySnapshot allData=await FirebaseFirestore.instance.collection('Notes').where('id',isEqualTo: FirebaseAuth.instance.currentUser!.uid).get();
